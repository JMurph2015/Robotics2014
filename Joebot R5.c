...
#pragma config(Motor,  port6,           higharm,       tmotorVex393, openLoop)
#pragma config(Motor,  port7,           lowarm,        tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port8,           leftext,       tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port9,           rightext,      tmotorVex393, openLoop)
...
task pickUp()
{
	while(true)
	{
		if(((abs(SensorValue[armenc]) - 15) < -1)&&(vexRT[Btn6D] != 1))
		{
			plbase=15;
			prbase=15;
		}
		...
		if(((abs(SensorValue[armenc]) - 15) > -1)&&((abs(SensorValue[armenc]) - 15) < 1)&&(vexRT[Btn6D] != 1))
		{
			motor[higharm]=127;
			motor[lowarm]=127;
			wait10Msec(200);
